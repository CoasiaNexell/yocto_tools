...
NEXELL_SOURCE_PATH_DISPATCHER=${ROOT_PATH}/secure/armv7-dispatcher
NEXELL_SOURCE_PATH_BL2_S5P4418=${ROOT_PATH}/secure/bl2-s5p4418
...
declare -a nexell_source_paths=($NEXELL_SOURCE_PATH_BL1_S5P4418 $NEXELL_SOURCE_PATH_BL1_S5P6818
                                ...
                                $NEXELL_SOURCE_PATH_DISPATCHER  $NEXELL_SOURCE_PATH_BL2_S5P4418
