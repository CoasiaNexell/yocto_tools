...
function usage()
{
    ...
    echo -e " <machine-name> : "
    echo -e "        s5p6818-artik710-raptor or s5p6818-bitminer-ref or s5p6818-artik710-raptor or s5p4418-avn-ref ...\n"
    echo -e " <image-type> : "
    echo -e "        qt, tiny, sato, tinyui, qtX11, bitminer \n"
    echo -e " -s : sdk create"
    echo -e " -c : cleanbuild"
    ...
    echo " ex) $0 s5p6818-bitminer-ref bitminer"
