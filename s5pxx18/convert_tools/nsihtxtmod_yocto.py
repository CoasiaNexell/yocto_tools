...
def modNSIHTXT(srcPath, inputFile, dummyFile, loadAddress, startAddress, keyTuple):
    tempFile1, tempFile2 = mkstemp()

    with fdopen(tempFile1, 'wt') as new_file:
        with open(dummyFile) as org_file:
...
def main(srcPath, inputFile, dummyFile, loadAddress, startAddress):
    modNSIHTXT(srcPath, inputFile, dummyFile, loadAddress, startAddress,
               (("0x044", "fileSize"),
                ("0x048", "loadAddress"),
                ("0x04C", "startAddress")))
