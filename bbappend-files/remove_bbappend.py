...
HASH_RECIPENAME_PATH = {
	...
	'linux-s5p4418-cluster-ref_%.bbappend':      ['ON',['/kernel/kernel-4.4.x',R_KERNEL,'/kernel-4.4.x'],  []],
	'linux-s5p4418-convergence-svmc_%.bbappend':      ['ON',['/kernel/kernel-4.4.x',R_KERNEL,'/kernel-4.4.x'],  []],
